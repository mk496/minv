...
public class AnnotationHelper {
     ...
     */
    private <T extends Annotation> String extractTypeName(final Class<?> annotatedClass,
    ...
    public class AnnotatedNavInfo {
        ...
        public String getFromRoleName() {
            ...
            if (isBiDirectional()) {
                return extractFromRoleEntityName(this.toField);
            }
            return extractToRoleName(this.toNavigation, this.toField);
        }
        ...
        public String getToRoleName() {
            ...
            return extractToRoleName(this.fromNavigation, this.fromField);
        }
        ...
        public EdmMultiplicity getFromMultiplicity() {
            ...
            return extractMultiplicity(this.toNavigation, this.toField);
        }
        ...
        public EdmMultiplicity getToMultiplicity() {
            ...
            return extractMultiplicity(this.fromNavigation, this.fromField);
        }
        ...
        public String getFromTypeName() {
            ...
            if (isBiDirectional()) {
                return extractEntityTypeName(this.toField.getDeclaringClass());
            }
            return extractEntityTypeName(this.fromField.getDeclaringClass());
        }

        public String getToTypeName() {

            if (isBiDirectional()) {
                return extractEntityTypeName(ClassHelper.getFieldType(this.toField));
            }
            return extractEntityTypeName(this.toField.getDeclaringClass());
        }
    ...
    private Class<?> determineAnnotatedClass(final EdmFunctionImport functionImport, final Method annotatedMethod) {
    ...
    public void setValueForAnnotatedField(final Object instance, final Class<? extends Annotation> annotation,
            final Object value) throws ODataAnnotationException {
     ...
     * @return
     */
    private List<Field> getAnnotatedFields(final Class<?> resultClass, final Class<? extends Annotation> annotation,
            final boolean inherited) {
    ...
    public List<Method> getAnnotatedMethods(final Class<?> resultClass, final Class<? extends Annotation> annotation,
            final boolean inherited) {
