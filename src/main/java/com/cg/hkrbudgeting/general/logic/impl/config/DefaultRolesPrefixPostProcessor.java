package com.cg.hkrbudgeting.general.logic.impl.config;
...
/**
 * This is an implementation of {@link BeanPostProcessor} that allows to change the role prefix of
 * spring-security. By default spring-security is magically adding a strange prefix called "ROLE_"
 * to your granted authorities. In order to prevent this we use this class with an empty prefix.
 */
