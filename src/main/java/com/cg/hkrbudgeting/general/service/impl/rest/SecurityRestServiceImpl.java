package com.cg.hkrbudgeting.general.service.impl.rest;

import com.cg.hkrbudgeting.general.common.api.exception.NoActiveUserException;
 ...
 * Furthermore, it provides functionality to check permissions and roles of the authenticated user.
 *
>>>>>>> HEAD~0
 */
@Path("/security/v1")
