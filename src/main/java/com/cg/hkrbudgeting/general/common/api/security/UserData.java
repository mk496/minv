package com.cg.hkrbudgeting.general.common.api.security;
...
public class UserData extends User implements Principal {
    ...
    /**
     * @return an instance of {@link UserDetailsClientTo} with the client side representation of
     *         this {@link UserData} instance.
     */
